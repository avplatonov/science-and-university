...
> Важно подчеркнуть тот факт, что нужно очень аккуратно подбирать веса $d_g$ для групп, поскольку размер группы имеет значение и если вес у большой группы будет равен или меньше е
